...
ActiveRecord::Schema[8.0].define(version: 2025_03_15_150515) do
  ...
  create_table "food_categories", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.index ["food_group_id"], name: "index_food_categories_on_food_group_id"
  end
  ...
  create_table "users", charset: "utf8mb4", force: :cascade do |t|
    ...
    t.date "next_password_reminder", default: "2026-03-15"
